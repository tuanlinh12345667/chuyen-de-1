            ...
            <table class="table table-hover text-center align-middle" id="myTable">
                ...
                <tbody>
                    @forelse($contacts as $contact)
                        <tr class="table__row">
                            <td><strong>#{{ $contact->MaLH }}</strong></td>
                            <td>{{ $contact->TenKH }}</td>
                            <td>{{ $contact->Email }}</td>
                            <td class="text-start">{{ $contact->TieuDe }}</td>
                            <td>
                                <button class="btn btn-sm btn-outline-primary btn-view-contact" data-id="{{ $contact->MaLH }}">
